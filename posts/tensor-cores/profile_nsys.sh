...
for memory in 16 32; do
  ...
  for size in $(seq 256 256 16384); do
    ...
    command="sudo /opt/nvidia/nsight-systems/2022.5.2/target-linux-tegra-armv8/nsys profile \
